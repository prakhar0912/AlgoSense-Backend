export default (daysLoggedIn) => {
    const today = new Date();
    const thirtyDaysAgo = new Date(today);
    thirtyDaysAgo.setDate(today.getDate() - 30);
    const uniqueDays = new Set(daysLoggedIn
    ...
    const consistencyScore = (0.5 * activeDaysRatio +
        0.3 * streakScore +
        0.2 * recencyScore) * 100;
    return (consistencyScore);
};
//# sourceMappingURL=getConsistencyScore.js.map