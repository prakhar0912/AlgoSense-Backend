...
const createProblemValidator = z.object({
  ...
  description: z.string().trim().min(10, 'description must be at least 10 characters long').max(4000, "Must be less than 1000 characters").transform((val) => sanitize(val)),
