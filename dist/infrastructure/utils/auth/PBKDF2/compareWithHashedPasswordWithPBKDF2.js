...
export default async function (password, hashedPassword) {
    ...
    const passwordKey = await webcrypto.subtle.importKey('raw', encoder.encode(password), 'PBKDF2', false, ['deriveBits']);
    const derivedBits = await webcrypto.subtle.deriveBits({
        name: 'PBKDF2',
        hash: 'SHA-512',
        salt,
        iterations,
    }, passwordKey, expectedDerivedKey.length * 8);
...
//# sourceMappingURL=compareWithHashedPasswordWithPBKDF2.js.map