...
const registerValidator = z.object({
  ...
  first_name: z.string().trim().min(1, 'First name is required').max(100, "Must be less than 100 characters").transform((val) => sanitize(val)).optional(), // Use sanitizedHtmlSchem
